    ...
    const analyticsData: AnalyticsData[] = [
        {
            ...
            hourlyTraffic: [
                ...
                { hour: 8, visitors: 456 },
                { hour: 9, visitors: 567 },
                { hour: 10, visitors: 678 },
                { hour: 11, visitors: 789 },
                { hour: 12, visitors: 834 },
                { hour: 13, visitors: 756 },
                { hour: 14, visitors: 689 },
                { hour: 15, visitors: 723 },
                { hour: 16, visitors: 645 },
                { hour: 17, visitors: 567 },
                { hour: 18, visitors: 489 },
                { hour: 19, visitors: 412 },
                { hour: 20, visitors: 356 },
                { hour: 21, visitors: 298 },
                { hour: 22, visitors: 245 },
                { hour: 23, visitors: 201 },
            ],
            deviceBreakdown: [
        ...
        },
        {
            ...
            hourlyTraffic: [
                ...
                { hour: 8, visitors: 345 },
                { hour: 9, visitors: 456 },
                { hour: 10, visitors: 523 },
                { hour: 11, visitors: 589 },
                { hour: 12, visitors: 634 },
                { hour: 13, visitors: 578 },
                { hour: 14, visitors: 512 },
                { hour: 15, visitors: 489 },
                { hour: 16, visitors: 445 },
                { hour: 17, visitors: 398 },
                { hour: 18, visitors: 334 },
                { hour: 19, visitors: 289 },
                { hour: 20, visitors: 234 },
                { hour: 21, visitors: 198 },
                { hour: 22, visitors: 156 },
                { hour: 23, visitors: 123 },
            ],
            deviceBreakdown: [
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        >
                            ...
                            {analyticsData.map(data => (
                                <option key={data.website} value={data.website}>
                                    {data.website}
                                </option>
                            ))}
                        </select>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-blue-900">
                                    {filteredData
                                        .reduce((sum, data) => sum + data.traffic, 0)
                                        .toLocaleString()}
                                </p>
                            </div>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-green-900">
                                    {filteredData
                                        .reduce((sum, data) => sum + data.uniqueVisitors, 0)
                                        .toLocaleString()}
                                </p>
                            </div>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-purple-900">
                                    {filteredData
                                        .reduce((sum, data) => sum + data.pageViews, 0)
                                        .toLocaleString()}
                                </p>
                            </div>
                                ...
                                <p className="text-2xl font-bold text-orange-900">
                                    {filteredData
                                        .reduce(
                                            (sum, data) =>
                                                sum +
                                                Object.values(data.conversions).reduce(
                                                    (a, b) => a + b,
                                                    0
                                                ),
                                            0
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-xs text-blue-600">
                                            Unique: {data.uniqueVisitors.toLocaleString()}
                                        </p>
                                    </div>
                                    <Users className="w-8 h-8 text-blue-600" />
                                </div>
                                ...
                                <div className="space-y-3">
                                    {Object.entries(data.conversions).map(([type, count]) => (
                                        ...
                                        >
                                            <div className="flex items-center space-x-3">
                                                <div
                                                    className={`p-2 rounded-lg ${getConversionColor(type)}`}
                                                >
                                    ...
                                    <tbody>
                                        {data.topPages.map((page, idx) => (
                                            <tr key={idx} className="border-b border-gray-200">
                                                ...
                                                <td className="p-3">
                                                    <span
                                                        className={`font-medium ${page.bounceRate < 40 ? 'text-green-600' : page.bounceRate < 50 ? 'text-yellow-600' : 'text-red-600'}`}
                                                    >
                                                        {page.bounceRate}%
                                                    </span>
                                                </td>
                                                ...
                                                <td className="p-3">
                                                    <span
                                                        className={`font-medium ${page.conversionRate > 2 ? 'text-green-600' : page.conversionRate > 1 ? 'text-yellow-600' : 'text-red-600'}`}
                                                    >
                                                        {page.conversionRate}%
                                                    </span>
                                                </td>
