...
const Clients: React.FC = () => {
    ...
    const getClientStats = () => {
        ...
        const totalRevenue = filteredClients.reduce(
            (sum, client) => sum + parseInt(client.totalSpent.replace(/[$,]/g, '')),
            0
        );
        const avgSatisfaction =
            filteredClients.reduce((sum, client) => sum + client.satisfaction, 0) /
                ...
                <div className="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p className="text-gray-600">
                            Manage existing clients and track relationships
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <div className="space-y-3 mb-4">
                            <div className="flex items-center justify-between">
                                ...
                                <span
                                    className={`px-2 py-1 rounded-full text-xs font-medium ${getTierColor(client.tier)}`}
                                >
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-2">
                                    ...
                                    <div className="flex items-center space-x-1">
                                        <span
                                            className={`font-medium ${getSatisfactionColor(client.satisfaction)}`}
                                        >
                                            {client.satisfaction}
                                        </span>
