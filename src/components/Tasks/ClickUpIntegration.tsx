        ...
        const mockTasks: ClickUpTask[] = [
            {
                ...
                description:
                    'Create wireframes and high-fidelity mockups for the new TechCorp campaign landing page',
            ...
            },
            {
                ...
                description:
                    'Configure GA4 tracking, set up conversion goals, and create custom dashboards',
            ...
            },
            {
                ...
                description:
                    'Review and approve social media content for the next month, ensure brand consistency',
                    ...
                    <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">
                                    {
                                        filteredTasks.filter(t => t.dueDate && isOverdue(t.dueDate))
                                            .length
                                    }
                                </p>
                            </div>
                                        ...
                                        >
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <div className="w-full bg-gray-200 rounded-full h-1">
                                                        <div
                                                            ...
                                                            style={{
                                                                width: `${getProgressPercentage(task.timeSpent || 0, task.timeEstimate)}%`,
                                                            }}
                                                        ></div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="flex items-center justify-between text-sm">
                                                <div className="flex items-center space-x-1">
                                                    ...
                                                    <span
                                                        className={`${task.dueDate && isOverdue(task.dueDate) ? 'text-red-600' : 'text-gray-600'}`}
                                                    >
                                                        {task.dueDate}
                                                    </span>
                                                </div>
                                ...
                                {filteredTasks.map(task => (
                                    ...
                                    >
                                        ...
                                        <td className="p-4">
                                            {task.priority && (
                                                <span
                                                    className={`text-sm font-medium ${getPriorityColor(task.priority.priority)}`}
                                                >
                                                    {task.priority.priority
                                                        .charAt(0)
                                                        .toUpperCase() +
                                                        task.priority.priority.slice(1)}
                                                </span>
                                            )}
                                        </td>
                                        <td className="p-4">
                                        ...
                                        <td className="p-4">
                                            <span
                                                className={`text-sm ${task.dueDate && isOverdue(task.dueDate) ? 'text-red-600' : 'text-gray-600'}`}
                                            >
                                                {task.dueDate}
                                            </span>
                                        </td>
