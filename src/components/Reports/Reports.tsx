...
import { BarChart3, TrendingUp, Download, Calendar, Filter, DollarSign, Users, Target, Clock } from 'lucide-react';
...
const Reports: React.FC = () => {
  ...
  const campaignData = [
    { name: 'TechCorp Digital Campaign', budget: '$45,000', spent: '$38,200', roi: '285%', status: 'active' },
    { name: 'StartupXYZ Brand Launch', budget: '$28,000', spent: '$25,600', roi: '195%', status: 'completed' },
    { name: 'Enterprise SEO Project', budget: '$75,000', spent: '$52,300', roi: '342%', status: 'active' },
    { name: 'Local Business Social Media', budget: '$12,000', spent: '$9,800', roi: '156%', status: 'active' },
    { name: 'Marketing Plus Content Strategy', budget: '$52,000', spent: '$48,900', roi: '278%', status: 'completed' },
  ];

  const teamPerformance = [
    { name: 'Sarah Johnson', role: 'Marketing Manager', clients: 8, revenue: '$285K', satisfaction: '4.9' },
    { name: 'Mike Chen', role: 'Digital Strategist', clients: 6, revenue: '$198K', satisfaction: '4.7' },
    { name: 'Emma Rodriguez', role: 'Content Lead', clients: 5, revenue: '$156K', satisfaction: '4.8' },
    { name: 'David Thompson', role: 'SEO Specialist', clients: 7, revenue: '$223K', satisfaction: '4.6' },
    { name: 'Lisa Martinez', role: 'Social Media Manager', clients: 4, revenue: '$134K', satisfaction: '4.9' },
  ];
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="text-left p-4 font-medium text-gray-900">Active Clients</th>
                <th className="text-left p-4 font-medium text-gray-900">Revenue Generated</th>
                <th className="text-left p-4 font-medium text-gray-900">Client Satisfaction</th>
              </tr>
            </thead>
            <tbody>
              {teamPerformance.map((member, index) => (
                <tr key={index} className="border-b border-gray-200">
                  ...
                  <td className="p-4 font-medium text-green-600">{member.revenue}</td>
                  <td className="p-4">
                    <div className="flex items-center space-x-1">
                      <span className="text-yellow-500">★</span>
                      <span className="font-medium text-gray-900">{member.satisfaction}</span>
                    </div>
                  </td>
                </tr>
              ))}
